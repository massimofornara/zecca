...
5. **Prelievo** — Chiunque abbia crediti può chiedere **euro o dollari** verso **IBAN** (bonifico SEPA o SWIFT) o un wallet. Massimo invia dalla banca o dal wallet, poi chiude con **CRO** (bonifico) o **hash reale** (crypto, verificato sulla rete): quella è la ricevuta. L’app non spedisce da sola.
