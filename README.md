...
5. **Prelievo** — Chiunque abbia crediti può chiedere **euro o dollari** verso **IBAN** o un wallet. Apri la richiesta (crypto: scegli moneta, quantità in crediti e wallet). L’hash di rete lo **cerca Zecca** su Etherscan, Blockscout, BscScan o Mempool dopo che l’invio è sulla rete: non lo inventa. Ogni prelievo chiuso ha una **ricevuta ufficiale** (`/ricevuta/…`) con hash SHA-256 del documento. L’app non dispone bonifici e non spedisce crypto.
