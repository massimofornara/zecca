...
5. **Prelievo** — Chiunque abbia crediti può chiedere **euro o dollari** verso **IBAN** o un wallet. Apri la richiesta (crypto: scegli moneta, quantità in crediti e wallet). L’hash di rete o il CRO si registrano **dopo** l’invio, sulla stessa schermata. Ogni prelievo chiuso ha una **ricevuta ufficiale** (`/ricevuta/…`) con hash SHA-256 del documento. In crypto l’hash di rete lo produce il wallet, Zecca lo verifica e non lo inventa. L’app non dispone bonifici e non spedisce crypto.
