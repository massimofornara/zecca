...
3. **Negozio** — Pezzi di massima fattura, pagati in crediti. **DHL Express 24h** a casa del cliente (18 cr) oppure consegna in casa di Massimo. Con `DHL_API_KEY` + account si prenota il ritiro vero; senza, la lettera di vettura resta locale.
