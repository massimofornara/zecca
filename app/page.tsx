  ...
  return (
    <PageShell>
      ...
      <section className="mt-6 grid gap-4 md:grid-cols-3">
        ...
        <Step n="02" title="La bottega" body="I crediti comprano pezzi di fattura alta. Si spediscono a casa tua o a casa di Massimo. Ogni spesa di oggi scalda la Forgia del Giorno." />
