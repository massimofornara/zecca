  ...
  return (
    <PageShell>
      <p className="text-xs uppercase tracking-[0.28em] text-primary/80">
        Zecca Gasless · chain {view.chainId} · non etherscan.io
      </p>
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground">
        ...
        {view.status === "success" ? "successo" : view.status}. Lo stesso hash è servito dall’API
        proxy stile Etherscan di Zecca; etherscan.io (Ethereum) non lo elenca.
      </p>
      ...
      <section className="metal-frame mt-8 rounded-md bg-card p-5">
        ...
        <div className="mt-4 space-y-3">
          ...
          <CopyField label="API stile Etherscan" value={view.etherscanApi} mono />
        </div>
        <p className="mt-4 text-xs text-muted-foreground">
          ...
          . Non aprire questo hash su etherscan.io: quella pagina è Ethereum mainnet.
        </p>
      </section>
    </PageShell>
  );
