  ...
  return (
    <PageShell>
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Il negozio spedisce i pezzi della bottega con DHL Express, ritiro a {CASA_MASSIMO.city}.
        Destinazione in Italia: 24 ore lavorative dopo il ritiro. Costo:{" "}
        {formatCredits(DHL_EXPRESS_24H_CREDITS)}, scalati dal portafoglio insieme alla merce.
      </p>
      <ol className="mt-8 max-w-2xl list-decimal space-y-3 pl-5 text-sm leading-relaxed">
        ...
        <li>Zecca crea la lettera di vettura DHL e, se il contratto è attivo, prenota il ritiro.</li>
        <li>Massimo imballa. DHL ritira. Tu segui il tracking.</li>
      </ol>
